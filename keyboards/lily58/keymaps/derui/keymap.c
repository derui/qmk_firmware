...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_QWERTY] = LAYOUT(
  ...
  M_LSFTESC,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
...
[_LOWER] = LAYOUT(
  ...
  KC_GRV, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   _______, _______, _______,_______, _______,  KC_DEL,
  _______, KC_LCTL, KC_LSFT, KC_LALT, KC_LGUI, _______,                   _______, _______, _______,_______, _______, _______,
  _______, KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, _______, _______, _______, _______, _______, _______, _______, _______, _______,
...
[_RAISE] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,                     KC_MINS, KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, KC_BSPC,
  _______, _______, _______, _______, _______, _______,  _______, _______,  KC_PLUS, KC_EQL, KC_UNDS, KC_PIPE, KC_BSLS, _______,
                             _______, _______, _______,  _______, _______,  _______, _______, _______
),
  [_ADJUST] = LAYOUT(
  QK_BOOT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, TG(_MAC),
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  XXXXXXX, KC_LCTL, KC_LSFT, KC_LALT, KC_LGUI, XXXXXXX,                   KC_LEFT, KC_DOWN,   KC_UP, KC_RIGHT, XXXXXXX, XXXXXXX,
